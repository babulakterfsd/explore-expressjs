...
// check admin role
router.route('/checkadminrole/:email').get(async (req, res) => {
...
router.route('/updateusertoadmin/:id').put(async (req, res) => {
    const { id } = req.params;
...
router.route('/getuserdetails/:email').get(async (req, res) => {
